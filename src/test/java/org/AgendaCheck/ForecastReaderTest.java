...
public class ForecastReaderTest {
    ...
    public void setUp() throws IOException {
        XSSFWorkbook forecast643 = new XSSFWorkbook(new FileInputStream("SampleInput/643_Gessef 2020.xlsx"));
        XSSFWorkbook forecast729 = new XSSFWorkbook(new FileInputStream("SampleInput/729 Gessef 2020.xlsx"));
